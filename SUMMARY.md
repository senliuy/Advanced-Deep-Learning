...
* [第五章：光学字符识别](di-wu-zhang-ff1a-guang-xue-zi-fu-shi-bie.md)
  * [场景文字检测](chapter1/chang-jing-wen-zi-jian-ce.md)
    ...
    * [PixelLink: Detecting Scene Text via Instance Segmentation](chapter1/pixellink-detecting-scene-text-via-instance-segmentation.md)
  * [文字识别](chapter1/wen-zi-shi-bie.md)
    ...
    * [multi-task learning for text recognition with joint CTC-attention](chapter1/multi-task-learning-for-text-recognition-with-joint-ctc-attention.md)
  ...
  * [二维信息识别](chapter1/er-wei-xin-xi-shi-bie.md)
    ...
    * [Show, Attend and Tell: Neural Image Caption Generation with Visual Attention](chapter1/er-wei-xin-xi-shi-bie/show-attend-and-tell-neural-image-caption-generation-with-visual-attention.md)
